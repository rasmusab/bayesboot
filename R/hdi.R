...
#'
#' @aliases hdi hdi.default hdi.matrix hdi.data.frame
#' @usage hdi(object, credMass = 0.95, ...)
#'
...
#' In that package there is support for calculating the hdi on more data types
#' than just vectors, matrices, and data frames.
#'
